...
function createEdgePaths(selection, g, arrows) {
  ...
  svgPaths.selectAll("path.path")
    .each(function(e) {
      ...
      var domEdge = d3.select(this)
        .attr("marker-end",   () => "url(" + makeFragmentRef(location.href, edge.arrowheadId) + ")" )
        .attr("marker-mid",   () => "url(" + makeFragmentRef(location.href, edge.arrowmidId)  + ")" )
        .attr("marker-start", () => "url(" + makeFragmentRef(location.href, edge.arrowtailId) + ")" )
        .style("fill", "none");
  ...
  svgPaths.selectAll("defs")
    .each(function(e) {
      ...
      arrowmid(  d3.select(this), edge.arrowmidId, edge, "arrowmid");
